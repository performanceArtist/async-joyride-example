...
import { lazyTour, TourStepName } from '../tour.model';
import {
  requestResult,
  RequestResult,
  selector,
...
const { TourWrapper, TourArea, TourContainer } = lazyTour;

export const Layout = pipe(
  selector.combine(TourWrapper, TourArea, TourContainer, TooltipContainer),
  selector.map(([TourWrapper, TourArea, TourContainer, TooltipContainer]) =>
